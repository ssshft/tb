...
class GateioTradingClient : public TradingClientBase{

public:
    GateioTradingClient(rapidjson::Value &accountConfig, sm::SecurityManager *smc);

    ~GateioTradingClient();
    GateioSpotTradingClient *gateioSpotTradingClient = nullptr;
    GateioUSwapTradingClient *gateioUSwapTradingClient = nullptr;
    // GateioCSwapTradingClient *gateioCSwapTradingClient = nullptr;
